...
<div id="header-small" class="masthead" style="display: none;">
				...
				<div id="cart">
					<c:choose>
						<c:when test="${!cart.isEmpty() && cart!=null}">
							<div>
								<spring:message code="cart.singleProductCount"
									arguments="${cart.size}" var="singleProductCount" />
								<spring:message code="cart.fewProductsCount"
									arguments="${cart.size}" var="fewProductsCount" />
								<spring:message code="cart.multiProductCount"
									arguments="${cart.size}" var="multiProductCount" />
								<c:choose>
